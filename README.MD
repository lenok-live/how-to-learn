...
Это мой первый проект реализованный в рамках курса Веб-разработчик от Яндекс.Практикум. Данный проект представляет собой типовой одностраничный сайт, который был сделан за два двухнедельных спринта.

В первом спринте я собирала его первую часть, затронув флексбокс-вёрстку, позиционирование и продвинутую семантику языка HTML. Во втором были применены навыки работы с анимациями, шрифтами и фреймами. Создана файловая структура CSS по методолгии БЭМ. Так же были переиспользовать блоки, которые являются общими для различных секций макета.
***

В проект были вставлены два видео [два](https://www.youtube.com/watch?v=arj7oStGLkU) и [видео](https://www.youtube.com/watch?v=5MgBikgcWnY).
    ...
    <footer class="footer">
      <div class="footer__columns">
        <div class="footer__column footer__column_content_copyright">
          ...
          <p class="footer__author">&copy; Елена Султанова</p>
        </div>
